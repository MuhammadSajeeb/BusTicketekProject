        ...
        <div class="row align-items-center">
            ...
            <div class="col-sm-6 clearfix">
                <div class="user-profile pull-right">
                    ...
                    <h4 class="user-name dropdown-toggle" data-toggle="dropdown">NUB-BUS ADMIN <i class="fa fa-angle-down"></i></h4>
...
@section('inner-content')
    <div class="main-content-inner">
                                        ...
                                        <tbody>
                                            @foreach ($bookings as $booking)
                                                <tr>
                                                    ...
                                                    <td>{{$booking->Trip->Bus->bus_type}}</td>
                                                    ...
                                                    <td>
                                                        <button type="button" class="btn btn-secondary btn-sm" onclick="addStyle()" data-toggle="modal" data-target="#modal-secondary-{{ $booking->id }}">
                                                            <i class="fas fa-edit">
                                                            </i>
                                                        </button>
        ...
        <script>
            ...
            function addStyle(){
                $('.modal').addClass('myClass');
                console.log($('.modal').addClass('myClass'));
            };
        </script>
